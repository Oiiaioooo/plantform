from main import app,Response,List,Field,BaseModel
from power_supplier.dp832 import DP832
...
@app.post("/dp832/", status_code=200)
async def set_dp832(dp832_config: dp832_config, response: Response):
    try:
        dp832 = DP832(dev_name=dp832_addr)
        for ch, voltage, current, output_state in zip(dp832_config.channels, dp832_config.voltages, dp832_config.currents,
...
@app.get("/dp832/config/", status_code=200)
...
@app.get("/dp832/data/", status_code=200)
